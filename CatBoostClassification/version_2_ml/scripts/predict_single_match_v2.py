...
FIXTURE_PATH = PROJECT_ROOT / "data" / "raw" / "worldcup_2026_fixtures_cleaned.csv"
ELO_PATH = PROJECT_ROOT / "data" / "raw" / "elo_ratings.csv"
FIFA_PATH = PROJECT_ROOT / "data" / "raw" / "fifa_rankings.csv"
...
def build_explanation(
    ...
    row = feature_row.iloc[0]
    d_team_1 = display_team_name(fixture.team_1)
    d_team_2 = display_team_name(fixture.team_2)
    ...
    return (
        ...
        f"CatBoost outcome probabilities were {d_team_1} {probabilities['team_1_win']:.1%}, "
        f"draw {probabilities['draw']:.1%}, {d_team_2} {probabilities['team_2_win']:.1%}. "
        f"Poisson expected goals were {d_team_1} {expected_goals_1:.2f} and "
        f"{d_team_2} {expected_goals_2:.2f}. "
...
def predict_single_match(team_1: str, team_2: str, stage: str, match_date: str) -> PredictionResult:
    ...
    elo = load_elo_csv(ELO_PATH)
    fifa = load_fifa_csv(FIFA_PATH)
    fixture = validate_fixture(team_1, team_2, stage, match_date, fixtures, elo, fifa)
    feature_row = build_feature_row(fixture, elo, fifa)
    d_team_1 = display_team_name(fixture.team_1)
    d_team_2 = display_team_name(fixture.team_2)

    print(f"Validated fixture: {d_team_1} vs {d_team_2}, {fixture.stage}, {fixture.match_date}")
