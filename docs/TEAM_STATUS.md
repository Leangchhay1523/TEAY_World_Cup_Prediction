...
| Team        | Player             | Status / Avail. | Reason                    | Type / Severity            | Impact                |
| ----------- | ------------------ | --------------- | ------------------------- | -------------------------- | --------------------- |
| **Brazil**  | Raphinha           | ❌ No           | Hamstring blow            | 🟡 Injury (Doubtful)       | 🔴 Key player         |
| **England** | Bukayo Saka        | ⚠️ Partial      | Achilles problem          | 🟡 Injury (Doubtful)       | 🔴 Key player         |
| **England** | Marcus Rashford    | 🟢 Yes          | Muscle strain             | 🟢 Injury (Minor)          | 🔴 Key player         |
| **England** | Tino Livramento    | ❌ No           | Calf injury               | 🔴 Injury (Out of Tourney) | ⚪ Bench player       |
| **Qatar**   | _Multiple Players_ | ❌ No           | Two ejections vs Canada   | 🟥 Red Card (1 Match)      | 🟡 Regular / ⚪ Bench |
| **Turkey**  | _Outfield Player_  | ❌ No           | Stoppage time vs Paraguay | 🟥 Red Card (1 Match)      | 🟡 Regular starter    |
